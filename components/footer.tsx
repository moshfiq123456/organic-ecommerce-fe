        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pt-16 pb-10 border-b border-background/10">
          ...
          >
            <div className="flex items-center gap-2.5 mb-3">
              <motion.img
                src={slug === "just-healthy" ? "/just-healthy-logo.png" : "/la-luminosite-logo.png"}
                alt="logo"
                className="w-auto object-contain brightness-0 invert h-24"
                whileHover={{ scale: 1.08 }}
                transition={{ type: "spring", stiffness: 300, damping: 18 }}
              />
            </div>
            <p className="text-background/40 text-xs font-light tracking-[0.28em] uppercase">
              {slug === "just-healthy" ? "Fresh · Organic · Wholesome" : "Pure · Natural · Radiant"}
            </p>
          </motion.div>
